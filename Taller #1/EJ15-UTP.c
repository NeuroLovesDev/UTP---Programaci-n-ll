...
int main ()
{
    ...
    resultado = (((valorvariable / 6) + (45 / valorvariable)) / (((((valorvariable - (-8/2)) / 12) / sqrt( valorvariable)) / 5) / sqrt (valorvariable))) + valorvariable * valorvariable * valorvariable * valorvariable;
